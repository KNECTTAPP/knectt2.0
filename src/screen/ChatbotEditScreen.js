...
const ChatbotScreen = ({ navigation, route }) => {
  ...
  var steps = [
    ...
    {
      id: "1",
      message: `Do you wish to make changes to your existing body profile?`,
      trigger: "3skip",
    },
    {
      id: "3skip",
      options: [
        { value: 1, label: "Yes, I want to.", trigger: "3" },
        { value: 2, label: "No, I am good.", trigger: "31" },
      ],
    },
    {
      id: "2",
    ...
    },
    {
      ...
      trigger: "12",
      validator: (number) => {
        if (number < 1) return "Your are not eligible";
        else {
          setAge(number);
          page = number;
          return true;
    ...
    {
      id: "16",
      message: ({ steps }) => `Your height is  ${steps["14h"].value} CM`,
      trigger: "17",
    },
    {
      id: "17",
    ...
    },
    {
      ...
      message: ({ steps }) => {
        insertBodyProfile();
        return `Congratulations.I have edited your body profile. You may now checkout your products, Under 'Body Matched' tab in navigation menu.Enjoy shopping`;
      },
      end: true,
    },
    {
