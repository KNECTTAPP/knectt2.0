...
const CheckoutAddressScreen = ({ navigation, route }) => {
  const active = true;
    ...
    <View style={styles.addressHolder}>
      {addressData ? (
        <View>
          ...
          >
            {addreSelect > 0 ? "Delivery Address" : "Select Delivery Address"}
          </Text>
          <FlatList
            style={{
              width: "100%",
              ...
              return (
                <View style={styles.addressContainer}>
                  <View style={styles.nameContainer}>
                    ...
                    <RadioButton
                      onPress={() => onRadioBtnClick(item.id, item)}
